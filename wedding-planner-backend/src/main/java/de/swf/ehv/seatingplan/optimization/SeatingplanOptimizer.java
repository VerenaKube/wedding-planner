...
public class SeatingplanOptimizer {
    ...
    private List<Pair<SeatingplanSolution, Integer>> rateSeatingplanSolutions(
        ...
        return seatingplanSolutions.stream()
                .map(solution -> Pair.of(solution, seatingplanSolutionEvaluator.evaluateSeatingplanSolution(solution)))
                .toList();
    }
    ...
    private List<SeatingplanSolution> mutateSeatingplanSolutions(List<SeatingplanSolution> seatingplanSolutions) {
        return new ArrayList<>();
    }

    private SeatingplanSolution findBestSeatingplanSolution(List<Pair<SeatingplanSolution, Integer>> solutionRatings) {
